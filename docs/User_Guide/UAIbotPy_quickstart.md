...
Click here to see the simulation above in a new tab: [creating_a_simulation.html](/assets/Python_examples/creating_a_simulation.html)
...
Click here to see the simulation above in a new tab: [adding_objects_to_the_simulation.html](/assets/Python_examples/adding_objects_to_the_simulation.html)
